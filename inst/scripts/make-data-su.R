...
data_dir <- path("https://zenodo.org/records/17430294/files/")
rds_path <- tempfile()
download.file(data_dir / "divas_results_combined_6block_renamed.rds", rds_path)
#final_data <- readRDS(rds_path)